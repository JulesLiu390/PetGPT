...
const SocialPanel = ({ assistants, apiProviders }) => {
  ...
  // Resolve available models for selected providers
  ...
  const visionProviderModels = sortModels(visionProvider?.cachedModels);
    ...
    <>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto px-4 py-3">
        <div className="space-y-4">
          ...
          <Card title="Prompts" description="Customize social behavior and reply profiles">
            <div className="space-y-3">
