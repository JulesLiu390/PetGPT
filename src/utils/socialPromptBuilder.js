...
- 已经说了我的看法了，等他们回应吧 [等回复：刚发完言在等反应]
- 刚回复了张三的问题，看看他怎么说 [等回复：球在对方那边，没必要再说]
...
- 如果你在对话记录末尾看到 assistant 消息（你自己的发言），而之后没有值得你再次开口的新消息，请选 [等回复]。你已经说过了，在等他们的反应，不需要重复发言
- [等回复] 和 [无感] 的区别：[无感] 是对话题不感兴趣；[等回复] 是你刚说完话、在等回应，本身可能对话题有兴趣但现在轮到别人说了
